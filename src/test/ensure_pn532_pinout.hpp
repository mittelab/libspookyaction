...
#ifndef KEYCARD_ACCESS_ENSURE_PN532_PINOUT_HPP
#define KEYCARD_ACCESS_ENSURE_PN532_PINOUT_HPP

#include <driver/gpio.h>

namespace ut::pn532::config {
    ...
    constexpr bool channel_is_supported(channel_type type) {
        switch (type) {
            case channel_type::i2c_irq:
                return config::supports_i2c_irq;
            case channel_type::i2c:
                return config::supports_i2c;
            case channel_type::hsu:
                return config::supports_hsu;
            case channel_type::spi:
                return config::supports_spi;
            case channel_type::spi_irq:
                return config::supports_spi_irq;
            default:
                return false;
        }
    }
...
#endif//KEYCARD_ACCESS_ENSURE_PN532_PINOUT_HPP
