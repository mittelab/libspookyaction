...
namespace desfire {
    ...
    /**
     * @brief Cryptographic operations that have to be implemented by @ref desfire::crypto.
     */
    enum struct crypto_operation {
        encrypt,///< Encryption, data is transformed into a ciphertext.
        decrypt,///< Decryption, ciphertext is transformed into plaintext.
     ...
     * might offer. Note that this is distinct from @ref protocol. While @ref protocol provides the mechanisms for managing
    ...
    public:
        /**
         * @brief Cipher used by this cryptographic implementation.
         */
        [[nodiscard]] virtual desfire::cipher_type cipher_type() const = 0;

        /**
         * @brief Sets the key to be used from now onwards in this cryptographic implementation.
         *
    ...
    public:
        ...
        /**
         * @brief Computes the CMAC on @p data using the given initialization vector @p iv.
         * The CMAC is nothing but the first 8 bytes of @p iv after @ref crypto_operation::mac has been run on @p data.
         *
         * @param data Data sequence for which the CMAC has to be computed. Remains constant.
         * @param iv Initialization vector to use. It is updated in place by this function.
         * @return The first 8 bytes of @p iv after the cryptographic operation has been done.
         */
    ...
    public:
        /**
         * @return @ref desfire::cipher_type::des
         */
    ...
    public:
        ...
        /**
         * @return @ref desfire::cipher_type::des3_2k
         */
        [[nodiscard]] inline desfire::cipher_type cipher_type() const final;
    ...
    public:
        ...
        /**
         * @return @ref desfire::cipher_type::des3_3k.
         */
        [[nodiscard]] inline desfire::cipher_type cipher_type() const final;
