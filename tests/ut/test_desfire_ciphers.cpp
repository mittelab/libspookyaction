...
namespace ut::desfire_ciphers {
    ...
    void test_aes_kdf() {
        ...
        TEST_ASSERT_EQUAL_HEX8_ARRAY(std::begin(div_key.body()), std::begin(exp_div_key), 16);
    }
    ...
    void test_3k3des_kdf() {
        ...
        TEST_ASSERT_EQUAL_HEX8_ARRAY(std::begin(div_key.body()), std::begin(exp_div_key), 24);
    }
